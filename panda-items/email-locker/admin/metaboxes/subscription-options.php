...
class OPanda_SubscriptionOptionsMetaBox extends FactoryMetaboxes321_FormMetabox
{
    ...
    public function showConfirmationMessageHeader(){
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label"></label>
            <div class="control-group controls col-sm-10">
                <?php printf( __('The confirmation email to send. You can change the sender email in the <a href="%s" target="_blank">global settings</a>.', 'emaillocker' ), opanda_get_settings_url('subscription') ) ?>
            </div>
        </div>
        <?php
    }
            ...
            <div class="control-group controls col-sm-10" id="opanda-fields-editor">
                ...
                <div class='opanda-options-templates'>
                    ...
                    <div class="opanda-options opanda-text-options">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><?php _e('Is Password', 'emaillocker') ?></label>
                            <div class="control-group col-sm-10">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class='opanda-is-password-input'>
                                        <?php _e('Check to hide content of this field behind "*".', 'emaillocker'); ?>
                                    </label>
                                </div>
                            </div>
                        </div>  
                    ...
                    <div class="opanda-options opanda-hidden-options">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><?php _e('Value', 'emaillocker') ?></label>
                            <div class="control-group col-sm-10">
                                <input type='text' class='form-control opanda-value-input' />
                                <div class='help-block'>
                                    <?php _e('This value will be saved when submitting the form.') ?>
                                </div>
                            </div>
                        </div>
    ...
    public function getLinkedInErrors() {
        ...
        $clientSecret = get_option('opanda_linkedin_client_secret', null);
         ...
         if ( empty( $clientId ) || empty( $clientSecret ) ) {
            return sprintf( __('You need to get LinkedIn Client ID and Secret for your website. Please <a href="%s" target="_blank">click here</a> to learn more.', 'optinpanda'), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=linkedin-api-key') );
        }
