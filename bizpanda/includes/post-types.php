...
class OPanda_PandaItemType extends FactoryTypes322_Type {
    ...
    public function useit() { return true; global $optinpanda;
if ( in_array( $optinpanda->license->type, array( 'paid','trial' ) ) ) {
 return true; 
}
    ...
    public function configure() {
        ...
        */  
        ...
        $this->scripts->add( OPANDA_BIZPANDA_URL . '/assets/admin/js/item-edit.010009.js')->request('jquery-ui-sortable');       
        $this->styles->add( OPANDA_BIZPANDA_URL . '/assets/admin/css/item-edit.010009.css');
